...
- 축하 시퀀스는 그래프 레이아웃을 2단계 애니메이션으로 전환합니다: (1) 1초 동안 노드를 원형 도넛 형태(두 개의 반지름 범위 사이)로 재배치, (2) 이어서 하트 곡선 배치로 2초간 부드럽게 인터폴레이션합니다. 이 애니메이션은 모든 노드를 연 후 발동한 축하 조건을 충족했을 때만 진행됩니다.
